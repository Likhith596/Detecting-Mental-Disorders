...
--
-- Database: `detecting_mental_disorders`
--
CREATE DATABASE IF NOT EXISTS `detecting_mental_disorders` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `detecting_mental_disorders`;
...
(4, 'Mahesh', 'Mahesh123@gmail.com', 'Mahesh', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(5, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(6, 'Rajesh', 'Rajesh123@gmail.com', 'Rajesh', '9535866270', 'India', 'Karnataka', 'Bangalore');
...
(1, 'Naive Bayes', '73.62668161434978'),
(2, 'SVM', '77.21412556053812'),
(3, 'Logistic Regression', '77.3822869955157'),
(4, 'Decision Tree Classifier', '69.22645739910314'),
(5, 'SGD Classifier', '77.83071748878923');
...
--
-- Table structure for table `remote_user_tweet_message_type_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_tweet_message_type_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `remote_user_tweet_message_type_prediction`
--

INSERT INTO `remote_user_tweet_message_type_prediction` (`id`, `Tweet_Message`, `Prediction`) VALUES
(1, 'brt davbingodav mcrackins oh fuck did i wrote fil  grinningfacewithsweatnsorry spot depressionface', 'Depression'),
(2, 'bperuz no ill kill u if u do poutingfacepoutingfacepoutingfacepoutingface', 'Anger'),
(3, 'i embark on a new year for once i feel somewhat invigorated that changes are just around the bend and that is a pleasantly unique feeling in my life', 'Positive'),
(4, 'bteamsiddshukla what is happening yar  twitter kholne se b darr lgta h rest in peace sanam k  hate you  ', 'Depression'),
(5, 'i feel a bit sad that we won t be seeing you anymore but we ll be recommending you to all our friends so you never know', 'Depression'),
(6, 'bnainonmeinbadra i aadmi is bari hamar zile ko red zone me dal diya nnfirstly person who added my district in red zone should be beaten', 'Anger'),
(7, 'bwish i had a boo to buy it for me so i can ignore her while i play with the boyz ', 'Depression'),
(8, 'i have some disbelieve feelings but i trust him i want to believe him whenever he said im pretty', 'Positive');
