"""detecting_mental_disorders URL Configuration
...
from detecting_mental_disorders import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Tweet_Message_Type/$', remoteuser.Predict_Tweet_Message_Type, name="Predict_Tweet_Message_Type"),
    ...
    url(r'^Find_Tweet_Message_Type_Ratio/$', serviceprovider.Find_Tweet_Message_Type_Ratio, name="Find_Tweet_Message_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Tweet_Message_Type/$', serviceprovider.View_Prediction_Of_Tweet_Message_Type, name="View_Prediction_Of_Tweet_Message_Type"),
